...
# Form implementation generated from reading ui file 'src/node_gui/ui/window/MainWindow.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menu_open_dir = QtGui.QAction(MainWindow)
        self.menu_open_dir.setObjectName(_fromUtf8("menu_open_dir"))
        ...
        self.menu_file.addAction(self.menu_open_dir)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menu_open_dir.setText(_translate("MainWindow", "Open &Path", None))
        self.menu_open_dir.setShortcut(_translate("MainWindow", "Ctrl+Shift+O", None))
