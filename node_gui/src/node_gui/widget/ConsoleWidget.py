...
from node_gui.widget.ConsoleActionsWidget import ConsoleActionsWidget
from node_gui.widget.ConsoleGPIOWidget import ConsoleGPIOWidget
from node_gui.widget.ConsoleWifiWidget import ConsoleWifiWidget

from node_gui.ui.widget.ConsoleWidget import Ui_ConsoleWidget
from node_gui.ui.widget.ConsolePanelWidget import Ui_ConsolePanelWidget
...
class ConsolePanelWidget(QtGui.QWidget):
    ...
    def show(self):
        ...
        self.window().ui.tabs.setCurrentIndex(0)
...
class ConsoleWidget(QtGui.QWidget):
    def __init__(self, *args, **kwargs):
        ...
        # self.ui.input.model = QtGui.QStringListModel(self.ui.input)
        # self.ui.input.completer = QtGui.QCompleter(self.ui.input)
        # self.ui.input.completer.setModel(self.ui.input.model)
        # self.ui.input.completer.setCompletionMode(QtGui.QCompleter.InlineCompletion)
        # self.ui.input.setCompleter(self.ui.input.completer)
    ...
    def onSendButtonClicked(self):
        ...
        # update autocompletion model
        # self.ui.input.model.setStringList(list(set(self.buffer)))
